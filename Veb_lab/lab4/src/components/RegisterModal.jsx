...
import { useAuth } from '../auth/providers/AuthContext';
    ...
    const handleRegister = (formData) => {
        signUp(formData).then(()=> { alert(`Дякуємо за реєстрацію!`);
    ...
    return (
        ...
        <div className="modal-content">
            ...
            <label>Password:<br /><input type="password" name="password" required value={formData.p} onChange={handleChange} /></label><br /><br />
